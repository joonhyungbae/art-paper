...
**Purpose**: Ensure all references and artwork/realization claims are not fabricated or erroneous before submission for review
...
2. Verification scope:
   ...
   - Phase C: 100% artwork/realization claim verification (per `shared/references/art_research_evidence_model.md` §4)
...
Reference: `art-pipeline/references/score_trajectory_protocol.md`
