...
See `art-reviewer/SKILL.md` for review process details.
...
- **Mode**: `art-reviewer` re-review mode
...
See `art-reviewer/SKILL.md` Re-Review Mode for verification review process.
