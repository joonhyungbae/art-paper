...
```
1. art-paper v0.1 ships English-only process records.
   (User-facing dialogue follows the user's language; the artifact itself is English.)
...
3. Generate Markdown version (paper_creation_process.md)
