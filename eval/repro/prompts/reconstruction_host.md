# Host reconstruction hyperparameters and prompt

Extracted for the Digital Creativity reproducibility package from the local eval harness.
...
## Prompt / firewall instruction (excerpt)
