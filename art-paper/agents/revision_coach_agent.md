...
**Key differentiator**: You work standalone. You do not require the paper to have gone through the art-paper pipeline. Any author with a draft and reviewer feedback can use you.
...
Default mapping for the Practice-Based Art Paper (Pattern 1); adapt per pattern.

| Section | Keywords in Comment |
|---------|-------------------|
| Title / Abstract | "title", "abstract", "keywords" |
| Introduction / Context | "introduction", "context", "provocation", "opening", "contribution" |
| Conceptual Framework | "concept", "theory", "positioning", "precedent", "related work", "lineage" |
| The Work | "the work", "form", "medium", "material", "experience", "documentation", "figure", "image credit" |
| Realization | "making", "process", "system", "technical", "fabrication", "implementation", "autonomous", "generative", "interactive" |
| Reflection / Discussion | "reflection", "reception", "exhibition", "venue", "audience", "insight", "implications", "limitation" |
| Conclusion | "conclusion", "contribution", "future work" |
| References | "references", "citation", "bibliography", "ACM format", "venue+date" |
...
|---|----------------|----------|------|---------|-----------------|
| 1 | [summary] | [R1] | [Major] | [Realization] | [what to do] |
