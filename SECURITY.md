...
1. Go to the [Security Advisories](https://example.com/art-paper/security/advisories) page.
...
- **Credential leakage** — configurations or agent behaviors that expose API keys (`CRS_CROSS_MODEL`, Semantic Scholar API key, etc.)
...
- Feature requests or general bugs — use [Issues](https://example.com/art-paper/issues) instead
