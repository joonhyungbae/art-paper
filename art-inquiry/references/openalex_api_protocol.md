...
- Spec: `ref/academic-research-skills/docs/design/2026-05-17-ars-v3.9.0-cross-index-triangulation-measurement-spec.md` §3.4
- Mirror template: `art-inquiry/references/semantic_scholar_api_protocol.md`
- Sibling protocol: `art-inquiry/references/crossref_api_protocol.md`
