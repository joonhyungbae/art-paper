...
art-inquiry provides 7 modes suited to different research stages and needs. This guide helps users select the most appropriate mode.
...
| **Expected Output** | Complete inquiry report (3,000-8,000 words): concept & positioning, practice-based methodology, lineage/precedent analysis, synthesis — handed off to art-paper for ACM-format authoring |
...
**Trigger Examples**:
```
"Research the lineage of generative-AI portraiture and position my new series"
"Deep inquiry into bio-art practices using living materials"
"Develop the concept and precedents for my interactive sound installation"
```
...
**Trigger Examples**:
```
"Quick research on the history of glitch art"
"Quick research on the latest trends in real-time generative installation"
```
...
**Trigger Examples**:
```
"Review this art paper"
"Help me review my practice-based methodology section"
"Check this manuscript before SIGGRAPH Asia submission"
```
...
**Trigger Examples**:
```
"Literature review on artistic uses of machine learning"
"Literature review: the evolution of interactive installation art"
"Systematic review of HCI studies on audience engagement in media art"
```
...
**Trigger Examples**:
```
"Fact-check these claims about which artwork was 'the first' to use a given technique"
"Fact-check: Was this piece really exhibited at Ars Electronica in 2019?"
"Verify: 'this is the earliest documented generative artwork'"
```
...
**Trigger Examples**:
```
"Guide my inquiry into what my new installation is really about"
"Guide my research on AI as an artistic medium"
"Help me think through the concept behind my work"
"Help me think through my art-research direction"
「引導我的創作研究：AI 作為媒材」
「幫我釐清我的作品概念」
「幫我想想，我對生成式影像有興趣但不確定作品要探問什麼」
「我有個模糊的創作想法，想找研究問題」
「帶我做創作研究」
```
...
| Item | Description |
|------|------|
| **Applicable Scenario** | Pattern-5 art-science hybrid only: a PRISMA-compliant systematic review of an empirical sub-question (e.g., HCI/perception studies relevant to the work), potentially with meta-analysis. NOT for the default practice-based art paper. |
| **Not Applicable** | The default practice-based art paper; exploratory inquiry without a focused PICOS question; narrative literature review; quick overview of a topic |
| **Typical Users** | Artist-researchers handling the empirical sub-question of an art-science hybrid, teams synthesizing prior HCI/perception evidence around a media-art work |
...
**Trigger Examples** (Pattern-5 hybrid empirical sub-questions):
```
"Systematic review of HCI studies on audience presence in interactive installations"
"Meta-analysis of the effect of haptic feedback on perceived immersion"
"PRISMA review of perception studies on generative imagery"
"Evidence synthesis on biofeedback methods relevant to my bio-art work"
```
...
| "I want to make a work about X" / 「我想做一件關於X的作品」(but can't articulate the inquiry) | Concept/inquiry clarification | `socratic`, not `full` | full mode's Phase 1 also offers interaction, but socratic goes deeper |
| "Help me fix this paper" | Paper revision guidance | `review`, not `full` | Already has text, needs review not research from scratch |
| "I need ACM-formatted references" | Reference formatting | `lit-review`, not `full` | If only a reference list and formatting is needed, no complete inquiry required |
| "Help me think of what my work is about" / 「幫我想作品的研究問題」 | Concept/direction exploration | `socratic` | Best suited for artists without a clear inquiry |
...
socratic → art-paper    Write paper directly after Socratic completion
...
systematic-review → art-paper  Write up systematic review as a paper
```

### art-inquiry to art-paper Mode Mapping

| art-inquiry Mode | Output | Maps to art-paper Mode | Description |
|-------------------|------|--------------------------|------|
...
### art-inquiry vs art-reviewer Mode Mapping

| art-inquiry `review` mode | art-reviewer |
|------------------------------|------------------------|
...
```
Step 1: art-inquiry (socratic/full)
          ↓ Research Plan / Full Report
Step 2: art-paper (plan/full)
          ↓ Paper draft
Step 3: art-reviewer (full/guided)
          ↓ Review comments
Step 4: art-paper (revision)
          ↓ Revised paper
...
### Transition: systematic-review → art-paper
