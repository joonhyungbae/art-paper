...
# repo's), art-paper_paper/ is a maintainer-local LaTeX working tree for the
# Aslib JIM methodology paper.
collect_ignore = ["ref", "art-paper_paper"]
collect_ignore_glob = ["ref/*", "art-paper_paper/*"]
