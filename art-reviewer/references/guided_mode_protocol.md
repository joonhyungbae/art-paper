...
- Use more questions, fewer commands ("Do you think the documentation anchors the 'real-time' claim well enough for a juror to trust it?" rather than "the realization claim is unsupported")
