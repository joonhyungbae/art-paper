...
|----------|------|---------------|------------|
| Jury Chair | [Art Papers Chair identity] | [Accept/Minor/Major/Reject] | [1-5] |
| Reviewer 1 | [Practitioner-Researcher identity] | [Accept/Minor/Major/Reject] | [1-5] |
| Reviewer 2 | [Curator identity] | [Accept/Minor/Major/Reject] | [1-5] |
| Reviewer 3 | [Art-Science / Media-Art Critic identity] | [Accept/Minor/Major/Reject] | [1-5] |
...
### Accept Version
We are pleased to accept your paper for the [Program / Venue — verify against current CFP]. [If applicable, include minor suggestions]
...
### Reject Version
After careful consideration, we are unable to accept your paper for the [Program / Venue]. We appreciate the effort you have put into this work and hope the jury's comments will be helpful for the future development of the work and the paper.

[If appropriate, recommend alternative venues / programs]
...
5. **Compatibility**: Format can be directly used as `art-paper` revision mode input
